...
export default function WhatsAppButton() {
  const whatsappNumber = '+351912345678'; // Concierge agency number
  const message = 'Olá! Gostaria de falar com um concierge da Andor sobre um itinerário de viagem premium.';
